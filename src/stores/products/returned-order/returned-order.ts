...
import { ISingleReturnedOrderPayment } from './type';
...
class ReturnedOrdersStore {
  ...
  singlePayment: ISingleReturnedOrderPayment | null = null;
  ...
  setSinglePayment = (singlePayment: ISingleReturnedOrderPayment | null) => {
