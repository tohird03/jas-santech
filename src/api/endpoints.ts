...
export enum Endpoints {
  ...
  ProductStatistic = '/statistics/product-mv',
  ProductStatisticCounts = '/statistics/many-product-stats',
  ...
  ArrivalProductMVOne = '/arrival-product-mv/one',
...
const config: Record<string, TStage> = {
  dev: {
    ...
    apiUrl: 'https://195-88-87-113.jas-santech.nip.io',
  },
  prod: {
    // apiUrl: 'https://tmp.16.170.250.134.nip.io',
    apiUrl: 'https://195-88-87-113.jas-santech.nip.io',
